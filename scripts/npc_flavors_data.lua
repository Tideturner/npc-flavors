...
Flavors = {
    ...
    ["build"] = {
        ...
        color = tColors,
        suffix = {
             "Active", "Alluring", "Generously padded", "Goliath", "Herculean", "Humpty Dumptyish", "Lilliputian", "Serpentine",
             "Shipshape", "Sloppy", "angular", "anorexic", "athletic", "atrophied", "awe-inspiring", "baggy", "baggy-figured",
             "bald", "barrel-chested", "battered", "beanstalk", "beat-up", "beefy", "beer-bellied", "big-bellied", "big-boned",
             "biggish", "bijou", "bloated", "blocky", "blubbery", "bony", "brawny", "brittle", "broad", "broad-shouldered",
             "broken", "bruised", "buff", "built", "bulbous", "bulging", "bulky", "bull-necked", "bullish", "bullnecked",
             "burly", "burnt", "busty", "buxom", "cadaverous", "careworn", "carved", "chaste", "chesty", "chiseled", "chubby",
             "chunky", "colossal", "coltish", "comely", "compact", "cooperative", "corpse-like", "corpulent", "crippled",
             "crooked", "crumbling", "cumbersome", "curvaceous", "curvy", "cylindrical", "dainty", "decomposed", "decrepit",
             "defined", "deformed", "degenerating", "delectable", "delicate", "dense", "deteriorating", "developed",
             "dilapidated", "diminutive", "dimpled", "doughy", "dumpy", "durable", "dwarfish", "eensy", "elephantine", "elfin",
             "emaciated", "endless", "endomorphic", "etiolated", "eye-catching", "fat", "fatso", "feeble", "feverish",
             "fine-boned", "firm", "fit", "flabby", "flat", "fleshy", "flimsy", "formidable", "foul-smelling", "fragile",
             "frail", "frangible,Gaunt", "full-figured", "furry", "gangling", "gangly", "gargantuan", "gawky",
             "generously proportioned", "giant", "gigantic", "ginormous", "girlie-girl", "gnarled", "gnomish", "graceful",
             "gross", "grotesque", "haggard", "hairy", "hale", "half-starved", "handsome", "hard", "hardy", "healthy",
             "heavily built", "heavy", "heavy-set", "hefty", "herculean", "hideous", "holy", "hourglass-shaped", "huge",
             "hulking", "humongous", "humpbacked", "hunchbacked", "hunched", "hunky", "husky", "immense", "imposing", "infirm",
             "in shape", "insubstantial", "inverted-triangular", "itsy-bitsy", "itty-bitty", "jumbo", "king-sized", "knee-high",
             "knee-high to a pygmy", "knee-high to a wastebasket", "lank", "lanky", "large", "large-boned", "lean", "leggy",
             "lethargic", "limber", "limp", "lissome", "lithe", "little", "lofty", "long-shanked", "longish", "low-slung",
             "lumpy", "lusty,Meaty", "maimed", "majestic", "malformed", "malnourished", "mammoth", "mangled", "massive",
             "matronly", "meager of body", "mesomorphic", "midget", "mighty", "milquetoast", "mini", "miniature", "misshapen",
             "monstrous", "mountain-high", "muscle-bound", "muscular", "narrow", "neat", "neckless", "neglected", "nimble",
             "nubile", "obese", "of great stature", "out of shape", "overweight", "packed-down", "pantywaist", "paunchy",
             "pear-shaped", "peewee", "perfect,Sculpted", "petite", "pigeon-chested", "pint-sized", "pliant", "plump",
             "pocket-sized", "podgy", "ponderous", "porky", "portly", "potbellied", "powerful", "powerfully built", "powerless",
             "pudgy", "puffy", "pumpkinesque", "puny", "pygmy", "pyramidal", "ramshackle", "rangy", "rawboned,Scraggy",
             "rectangular", "redwood-high,Sizable", "resilient", "revolting", "rickety", "ripped", "robust", "roly-poly",
             "ropy", "rotting", "rotund", "round-shouldered", "round-shouldered,Scarred", "rugged", "runty,Sawed-off",
             "runty,Scalded", "scrawny", "seductive", "sensuous", "sexy", "shaggy", "shapeless", "shapely", "short",
             "shoulder-high", "shoulderless", "shredded", "shrimpy", "shriveled", "shrunken", "sickly", "sinewy", "sinuous",
             "skeletal", "skin-and-bone", "skinny", "sky-high", "slack", "sleek", "slender", "slight", "slightly-built", "slim",
             "slinky", "slouched", "small", "small-boned", "small-scale", "small-waisted", "small in stature", "solid",
             "soulless", "sound", "spare", "spherical", "spidery", "spindly", "spiny", "square", "squat", "stacked",
             "stalwart [dated]", "starved", "stately", "statuesque", "stocky", "stooped", "stout", "strapping", "streamlined",
             "stringy", "strong", "stubby", "stunning", "stunted", "sturdy", "substantial", "sumoesque", "supple", "svelte",
             "swollen", "sylphlike", "symmetrical", "tall", "taut", "teeny", "teeny-weeny", "thick", "thick-waisted",
             "thickset", "thin", "tiny", "toned", "top-heavy", "tough", "towering", "triangular", "trim", "tubby", "twisted",
             "underdeveloped", "underfed", "undernourished", "undersized", "underweight", "ungainly", "unresponsive",
             "unwashed", "unwieldy", "unwilling", "unyielding", "vertically challenged", "vigorous", "voluptuous", "vulnerable",
             "waif-like", "waist-high", "wasp-waistedBelly-button-high", "wasted", "weak", "wee,Big", "weedy", "weighty",
             "well-built,Ailing", "well-endowed", "well-fed", "well-padded", "well-proportioned", "well-rounded", "whopping",
             "wide,Aerodynamic", "willowy", "willowyAmple", "wimpy", "wiry", "withered", "wizened", "wooden",
             "worn-out,Barrel-chested", "wrinkled", "youthful,Awkward"
        }
    },
    ["behavior"] = {
